...
<div id="wrapper"  style="background-color: white">
    ...
    <div class="row">
        ...
        <div class="col-sm-9" id="content" >
            ...
            <div class="col-12">
                <div style="max-height:600px;margin-top: 100px">
                    <table class="table">
                        <thead>
                        <tr>
                            ...
                            {{--<th scope="col">قیمت برای بزرگسال</th>--}}
                            {{--<th scope="col">قیمت برای نوزاد</th>--}}
                        ...
                        <tbody>
                            ...
                            @foreach($responses['PricedItineraries'] as $response)
                                <tr>
                                    <th scope="row">{{++$i}}</th>
                                    <td>
                                        {{$response['AirItinerary']['OriginDestinationOptions']
                                    ...
                                    <td>
                                        <?php
                                        $type=$response['AirItinerary']['OriginDestinationOptions']
                            ...
                            {{--<td>--}}
                            {{--{{$res['PricedItineraries'][0]['AirItinerary']['OriginDestinationOptions']--}}
                            {{--[0]['FlightSegment'][0]['CabinType']['value']}}--}}
                            {{--</td>--}}
                            {{--<td>--}}
                            {{--{{$res['PricedItineraries'][0]['AirItineraryPricingInfo']['OriginDestinationOptions']--}}
                            {{--[0]['FlightSegment'][0]['CabinType']['value']}}--}}
                            {{--</td>--}}
